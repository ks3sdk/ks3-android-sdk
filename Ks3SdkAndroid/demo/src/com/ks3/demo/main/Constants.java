...
public class Constants {
	...
	public static final String APP_SERTVER_HOST = "http://192.168.231.49:11911";
	// public static final String APP_SERTVER_HOST = "YOUR_APP_SERVER_HOST";
	// 测试用AK&SK
	public static final String ACCESS_KEY__ID = "IYh4GQWndtnQvmCJWFL4";
	public static final String ACCESS_KEY_SECRET = "1+RBTrWaeT6LaixUV5SGPFpeTa/wZEeZlGzYaZfr";
	public static final long MULTI_UPLOAD_THREADHOLD = 5 * 1024 * 1024;
}
