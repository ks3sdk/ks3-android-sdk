						...
						client.putObject(name, key, file,
								new PutObjectResponseHandler() {
									...
									public void onTaskFailure(int statesCode,
										...
										StringBuffer stringBuffer = new StringBuffer();
										stringBuffer
												.append("upload file failure,file = "
														+ Constants.TEST_IMG
														+ ",states code = "
														+ statesCode)
												.append("\n")
...
//				symKey);
		...
		// // Asymetric Ways Key
		 ...
		 Log.d(com.ksyun.ks3.util.Constants.LOG_TAG, "key pair");
		 } catch (NoSuchAlgorithmException e) {
		 e.printStackTrace();
		 }
		...
		ks3EncryptionClient = Ks3EncryptionClient.getInstance(
				...
				asymmertricEncryptionMaterials, new CryptoConfiguration(),
				MainActivity.this);
//		ks3EncryptionClient = Ks3EncryptionClient.getInstance(
//				Constants.ACCESS_KEY__ID, Constants.ACCESS_KEY_SECRET,
						...
						client.getObjectACL(name, key,
								new GetObjectACLResponseHandler() {
									...
									public void onFailure(int statesCode,
										...
										StringBuffer stringBuffer = new StringBuffer();
										stringBuffer
												.append("get object ACL FAIL !!!!!!, states code :"
														+ statesCode)
												.append("\n")
												.append("response:")
												.append(response);
						...
						client.putObjectACL(request,
								new PutObjectACLResponseHandler() {
									...
									public void onFailure(int statesCode,
										...
										StringBuffer stringBuffer = new StringBuffer();
										stringBuffer
												.append("PUT Object ACL FAIL !!!!!!!!!, states code :"
														+ statesCode)
												.append("\n")
												.append("responce:")
												.append(response);
			...
			public void confirmBucket(String name) {
				client.headBucket(name, new HeadBucketResponseHandler() {
					...
					public void onFailure(int statesCode, Ks3Error error,
						...
						StringBuffer stringBuffer = new StringBuffer();
						stringBuffer
								.append("head Bucket Fail, states code :"
										+ statesCode).append("\n")
			...
			public void confirmBucket(String name) {
				...
				client.putBucketACL(request, new PutBucketACLResponseHandler() {
					...
					public void onFailure(int statesCode, Ks3Error error,
						...
						StringBuffer stringBuffer = new StringBuffer();
						stringBuffer
								.append("PUT Bucket ACL FAIL, states code :"
										+ statesCode).append("\n")
								.append("responce :").append(response);
						stringBuffer.append("Exception :"
								+ paramThrowable.toString());
			...
			public void confirmBucket(String name) {
				client.getBucketACL(name, new GetBucketACLResponceHandler() {
					...
					public void onFailure(int statesCode, Ks3Error error,
						...
						StringBuffer stringBuffer = new StringBuffer();
						stringBuffer
								.append("GET BUCKET ACL fail , states code :"
										+ statesCode).append("\n")
								.append("response = ").append(response);
						stringBuffer.append("Exception :"
								+ paramThrowable.toString());
						...
						client.deleteObject(request,
								new DeleteObjectRequestHandler() {
									...
									public void onFailure(int statesCode,
										...
										StringBuffer stringBuffer = new StringBuffer();
										stringBuffer
												.append("Delete fail , states code :"
														+ statesCode)
												.append("\n")
												.append("response:")
												.append(response);
	...
	private void listBuckets() {
		client.listBuckets(new ListBucketsResponceHandler() {
			...
			public void onFailure(int statesCode, Ks3Error error,
				...
				StringBuffer stringBuffer = new StringBuffer();
				stringBuffer
						.append("list bucket fail , states code :" + statesCode)
						.append("\n").append("responce :").append(response);
