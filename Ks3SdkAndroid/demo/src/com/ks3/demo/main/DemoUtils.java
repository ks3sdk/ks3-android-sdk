...
public class DemoUtils {
	public static Drawable matchImage(Context context, boolean isDir,
			String fileName) {
		...
		if (fileName.endsWith(".apk"))
			...
			return resources.getDrawable(R.drawable.ks_format_reg);
		else if (fileName.endsWith(".rm"))
			return resources.getDrawable(R.drawable.ks_format_rm);
		else if (fileName.endsWith(".rmvb"))
			return resources.getDrawable(R.drawable.ks_format_rmvb);
		else if (fileName.endsWith(".swf"))
			return resources.getDrawable(R.drawable.ks_format_swf);
		else if (fileName.endsWith(".txt"))
			return resources.getDrawable(R.drawable.ks_format_txt);
		else if (fileName.endsWith(".wav"))
			return resources.getDrawable(R.drawable.ks_format_wav);
		else if (fileName.endsWith(".wma"))
			return resources.getDrawable(R.drawable.ks_format_wma);
		else if (fileName.endsWith(".wmv"))
			return resources.getDrawable(R.drawable.ks_format_wmv);
		else if (fileName.endsWith(".xls"))
			return resources.getDrawable(R.drawable.ks_format_xls);
		else if (fileName.endsWith(".xlsx"))
			return resources.getDrawable(R.drawable.ks_format_xlsx);
		else if (fileName.endsWith(".zip"))
			return resources.getDrawable(R.drawable.ks_format_zip);
		else if (fileName.endsWith(".jpeg"))
			return resources.getDrawable(R.drawable.ks_format_jpg);
		else if (fileName.endsWith(".xml"))
			return resources.getDrawable(R.drawable.ks_format_xml);
		else
			return resources.getDrawable(R.drawable.ks_format_unkown);
	}
