...
public abstract class GetObjectResponceHandler extends FileAsyncHttpResponseHandler{

	private String mBucketName;
	private String mObjectKey;
	
	private GetObjectResponceHandler(File file , boolean append){
		super(file, append);
	}
	
	public GetObjectResponceHandler(File file,String buckName,String objectKey) {
		this(file, false);
