...
public class CopyObjectRequest extends Ks3HttpRequest{
	...
	protected void setupRequest() {
		...
		try {
			this.addHeader(HttpHeaders.XKssCopySource,"/"+this.getSourceBucket()+"/"+URLEncoder.encode(this.getSourceKey(),"UTF-8"));
